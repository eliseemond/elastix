 ...
 *
 *=========================================================================*/
#ifndef __elxAdvancedNormalizedCorrelationOverLastDimensionMetric_H__
#define __elxAdvancedNormalizedCorrelationOverLastDimensionMetric_H__

#include "elxIncludes.h" // include first to avoid MSVS warning
#include "itkAdvancedNormalizedCorrelationOverLastDimensionImageToImageMetric.h"

namespace elastix
{

/**
 * \class AdvancedNormalizedCorrelationOverLastDimensionMetric
 * \brief An metric based on the itk::AdvancedNormalizedCorrelationOverLastDimensionImageToImageMetric.
 *
 * The parameters used in this class are:
 * \parameter Metric: Select this metric as follows:\n
 *    <tt>(Metric "AdvancedNormalizedCorrelationOverLastDimension")</tt>
...
class AdvancedNormalizedCorrelationOverLastDimensionMetric :
  public
  itk::AdvancedNormalizedCorrelationOverLastDimensionImageToImageMetric<
...
public:
  ...
  /** Standard ITK-stuff. */
  typedef AdvancedNormalizedCorrelationOverLastDimensionMetric Self;
  typedef itk::AdvancedNormalizedCorrelationOverLastDimensionImageToImageMetric<
    typename MetricBase< TElastix >::FixedImageType,
  ...
  itkTypeMacro( AdvancedNormalizedCorrelationOverLastDimensionMetric, itk::AdvancedNormalizedCorrelationOverLastDimensionImageToImageMetric );

  /** Name of this class.
   * Use this name in the parameter file to select this specific metric. \n
   * example: <tt>(Metric "AdvancedNormalizedCorrelationOverLastDimension")</tt>\n
   */
  elxClassNameMacro( "AdvancedNormalizedCorrelationOverLastDimension" );
...
protected:
  ...
  /** The constructor. */
  AdvancedNormalizedCorrelationOverLastDimensionMetric() {}
  /** The destructor. */
  ~AdvancedNormalizedCorrelationOverLastDimensionMetric() override {}

private:

  /** The private constructor. */
  AdvancedNormalizedCorrelationOverLastDimensionMetric( const Self & );  // purposely not implemented
...
#include "elxAdvancedNormalizedCorrelationOverLastDimensionMetric.hxx"
#endif

#endif // end #ifndef __elxAdvancedNormalizedCorrelationOverLastDimensionMetric_H__
